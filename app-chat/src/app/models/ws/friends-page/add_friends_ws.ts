export class AddFriendsInforWS {
    id: any;
    img: string;
    name: string;
  ...
  public checkLimitNameMutualAdd() {
    if (this.name != undefined) {
