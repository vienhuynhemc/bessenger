...
import { ObjectChatFooterWS } from 'src/app/models/ws/chat-page/chat-page-chat-page/footer/object_chat_footer';

@Injectable({
  providedIn: 'root'
})
export class MessengerFooterWsService {
  public chenh_lech_height: number;
  public object_chat_footer: ObjectChatFooterWS;
  ...
  constructor(
    ...
    this.object_chat_footer = new ObjectChatFooterWS();
  }
  ...
  public getThongTinCoBan(id: string) {
    return this.db.object("/cuoc_tro_chuyen_ws/" + id).snapshotChanges();
  }
