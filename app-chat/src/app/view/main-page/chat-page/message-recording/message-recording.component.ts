...
@Component({
  selector: 'app-message-recording',
  templateUrl: './message-recording.component.html',
  styleUrls: ['./message-recording.component.scss']
})
export class MessageRecordingComponent implements OnInit {
  state:string = 'pause';
  intervalPlay: any;
  timeOutPlay: any;
