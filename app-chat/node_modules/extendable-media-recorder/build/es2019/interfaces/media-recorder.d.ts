...
export interface IMediaRecorder extends TNativeEventTarget {
    ...
    addEventListener<K extends keyof IMediaRecorderEventMap>(type: K, listener: (this: this, event: IMediaRecorderEventMap[K]) => void, options?: boolean | AddEventListenerOptions): void;
    addEventListener(type: string, listener: EventListenerOrEventListenerObject, options?: boolean | AddEventListenerOptions): void;
    removeEventListener<K extends keyof IMediaRecorderEventMap>(type: K, listener: (this: this, event: IMediaRecorderEventMap[K]) => void, options?: boolean | EventListenerOptions): void;
